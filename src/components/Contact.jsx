...
function Contact() {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      label: 'Address',
      value: 'Hirondini Park, Oragadam, Chennai, Tamil Nadu',
      href: '#',
    },
  ]
      ...
      <div className="container">
        ...
        >
          ...
          <p className="section-subtitle">
            Ready to experience luxury living? Reach out via WhatsApp for the fastest response or drop us an email.
          </p>
        </motion.div>
